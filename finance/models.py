...
class Expense(models.Model):
    ...
    submitted_by = models.ForeignKey('core.EmployeeProfile',on_delete=models.SET_NULL,null=True,blank=True,related_name='expenses_submitted')
    approved_by = models.ForeignKey('core.EmployeeProfile',on_delete=models.SET_NULL,null=True,blank=True,related_name='expenses_approved')
